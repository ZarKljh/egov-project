...
<head>
    ...
    <title>비밀번호 재설정 완료 - 전자정부프레임워크</title>
    ...
    <div class="container-fluid d-flex vh-100 align-items-center justify-content-center">
        <div class="card shadow-lg" style="width: 100%; max-width: 500px;">
            <div class="card-body p-5 text-center">
                ...
                <h2 class="card-title mb-3">비밀번호 재설정 완료</h2>
                <p class="text-muted mb-4">비밀번호가 성공적으로 재설정되었습니다.</p>
                <div class="d-grid">
                    <a href="{{ route('register') }}" class="btn btn-primary">로그인하러 가기</a>
                </div>
            </div>
        </div>
    </div>
